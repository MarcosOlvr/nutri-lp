...
export default function Cta() {
    return (
        <section className="relative bg-emerald-900 py-20 px-6 overflow-hidden">

            {/* Decoração esquerda - esconde no mobile, mostra no desktop */}
            <div className="hidden md:block absolute -left-16 top-1/2 -translate-y-1/2 w-64 h-64 rounded-full border-[40px] border-green-400 opacity-80" />
            <div className="hidden md:block absolute left-24 top-1/2 -translate-y-1/2 w-0 h-0 border-l-[60px] border-l-transparent border-r-[60px] border-r-transparent border-b-[100px] border-b-green-400 opacity-60 rotate-12" />
            ...
            <div className="absolute right-0 top-0 w-0 h-0 border-l-[120px] border-l-transparent border-r-[120px] border-r-green-400 border-b-[200px] border-b-transparent" />
            <div className="absolute right-0 bottom-0 w-0 h-0 border-l-[120px] border-l-transparent border-r-[120px] border-r-green-400 border-t-[200px] border-t-transparent" />
            </div>

            {/* Decoração mobile - apenas bolinhas simples */}
            <div className="md:hidden absolute -left-8 top-1/2 -translate-y-1/2 w-24 h-24 rounded-full border-[16px] border-green-400 opacity-40" />
            <div className="md:hidden absolute -right-8 top-1/2 -translate-y-1/2 w-24 h-24 rounded-full border-[16px] border-green-500 opacity-40" />
