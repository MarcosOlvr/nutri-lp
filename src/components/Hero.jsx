...
export default function Hero() {
    return ( 
    <section className="relative min-h-screen flex items-center justify-center py-16 sm:py-20 px-4 sm:px-6 lg:px-8 overflow-hidden bg-silver">      
        <div className="max-w-7x mx-auto text-center relative w-full pt-10">
            <div className="max-w-7xl mx-auto flex flex-col text-center gap-6 sm:gap-8 lg:gap-12 items-center relative">
                <div>
                    <h1 className="text-3xl sm:text-3xl md:text-4xl font-semibold mb-4 sm:mb-6 animate-in slide-in-from-bottom duration-700 delay-100 tracking-normal">
                    ...
                    <div className="flex flex-col items-center justify-center gap-3 sm:gap-4 animate-in slide-in-from-bottom duration-700 delay-300 py-3">
                        <a href="#planos">
                ...
                <div className="relative order-2 w-full lg:w-4xl shadow-2xl">
                    <iframe className="aspect-video rounded-lg" src="https://www.youtube.com/embed/T939YUUrLB8?si=z0ZsfQ9p61U9WY-R" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </section>
